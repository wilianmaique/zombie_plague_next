...
public register_class()
{
	...
	zpn_class_set_prop(class, CLASS_PROP_REGISTER_INFO, "Run, and grab the player")
	zpn_class_set_prop(class, CLASS_PROP_REGISTER_MODEL, "zpn_charger")
	zpn_class_set_prop(class, CLASS_PROP_REGISTER_MODEL_VIEW, "models/player/zpn_charger/hand.mdl")
	zpn_class_set_prop(class, CLASS_PROP_REGISTER_SPEED, 360.0)
	zpn_class_set_prop(class, CLASS_PROP_REGISTER_HEALTH, 2200.0)
	zpn_class_set_prop(class, CLASS_PROP_REGISTER_GRAVITY, 0.8)
	zpn_class_set_prop(class, CLASS_PROP_REGISTER_KNOCKBACK, 1.0)
	zpn_class_set_prop(class, CLASS_PROP_REGISTER_BLOOD_COLOR, 10)
