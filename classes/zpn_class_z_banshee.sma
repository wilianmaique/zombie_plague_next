...
register_class()
{
	...
	zpn_class_set_prop(class, CLASS_PROP_REGISTER_MODEL, "zpn_z_banshee")
	zpn_class_set_prop(class, CLASS_PROP_REGISTER_MODEL_VIEW, "models/player/zpn_z_banshee/hand.mdl")
